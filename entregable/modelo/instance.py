...
class Instance:
    ...
    def generate_services(self, period, scenario):
        ...
        ----------------------------------------------------------
        INPUT:
            period: periodo de llegada
            scenario: escenario en cuestión
        '''
    ...
    def create_instance(self, base_cases):
        ...
        -----------------------------------------------
        INPUT:
            base_cases: lista de casos base. Cada caso está representado
                        por un diccionario de key id del servicio y key
                        una tupla (hweeks, weeks) donde hweeks es la cantidad
                        de horas semana y weeks la cantidad de semanas que requiere
                        el servicio de identificador id
        '''
